<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypingNoPassage.aspx.cs" Inherits="TypePro.Pages.TypingNoPassage" %>
                                ...
                                <td style="font-family: Arial; font-size: 9pt">
                                    <div id="typeArea" style="display: block;">
                                        ...
                                        <textarea id="txtUserType" runat="server"  onkeydown="if (event.keyCode == 9)
                                                   ...
                                                   name="typed" cols="53" rows="10" wrap="soft" spellcheck="false" style="width: 100%; border: 1px solid #344270; padding: 2px; font-family: Arial; font-size: 13pt"   ></textarea>
                                        </font>
                                    </div>
                                    ...
                                    <div id="result" style="">
                                        <table width="100%" style="font-weight: 600;" cellpadding="5" cellspacing="5">
                                            ...
                                            <tr>
                                                <td>Total Time :- </td>
                                                <td>
                                                    <div id="timemain" runat="server">Waiting...</div>
                                                </td>
